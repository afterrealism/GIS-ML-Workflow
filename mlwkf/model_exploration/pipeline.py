...
from mlwkf.registry import lookup_model, lookup_scoring_functions, safe_parse_dict, safe_parse_list
...
def run_model_exploration_pipeline(config_file_path):
    ...
    scoring_functions = lookup_scoring_functions(config.get('ModelExploration', 'scoring_functions'))
    ...
    selected_features = safe_parse_list(config.get('Intermediate', 'selected_features', fallback='None'))
